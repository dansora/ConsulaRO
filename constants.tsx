...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  RO: {
    ...
    btn_google: "Continuă cu Google",
    btn_facebook: "Continuă cu Facebook",
    nav_home: "Acasă",
  ...
  IT: {
    ...
    btn_facebook: "Continua con Facebook",
    nav_home: "Home",
